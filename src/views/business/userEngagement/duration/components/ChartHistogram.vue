  ...
  methods: {
    initChart() {
      ...
      chart.tooltip({
        ...
        <span style="margin-right:20px"> {use_time}</span>
       {StartsNum}
        </div>
        `,
      });
      ...
      chart
        .interval()
        .position("use_time*StartsNum")
        .color("pt")
        .tooltip("use_time*StartsNum", function (use_time, StartsNum) {
          return { use_time, StartsNum };
        });
      chart.render();
    },
    handleChartData() {},
